...
__kernel void rebound(const param_t params, __global speed_t* cells, __global speed_t* tmp_cells, __global char* obstacles)
{
...
__kernel void collision(const param_t params, __global speed_t* cells, __global speed_t* tmp_cells, __global char* obstacles)
{
    int ii,jj,kk;                 /* generic counters */
    ii = get_global_id(1);
    jj = get_global_id(0);
...
__kernel void av_velocity(const param_t params, __global speed_t* cells, __global char* obstacles, __global float* tot_u)
{
    int    ii,jj,kk;       /* generic counters */
    ii = get_global_id(1);
    jj = get_global_id(0);
